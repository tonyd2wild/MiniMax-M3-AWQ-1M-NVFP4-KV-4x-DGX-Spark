...
class MiniMaxM3IndexerBackend(AttentionBackend):
    ...
    # "nvfp4" is accepted so --kv-cache-dtype nvfp4 validates, but the side
    # cache STORAGE stays bf16 (MLAAttentionSpec dtype below; Phase 2 may
    # quantize it via indexer_kv_dtype).
